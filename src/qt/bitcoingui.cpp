...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NATU address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and natu: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NATU"), this);
    aboutAction->setStatusTip(tr("Show information about NATU"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NATU"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NATU addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NATU addresses"));
    ...
    openAction->setStatusTip(tr("Open a NATU: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NATU help message to get a list with possible NATU command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NATU client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NATU network", "", count));
}
...
{
    QString strTitle = tr("NATU"); // default title
