/* src/config/natu-config.h.  Generated from natu-config.h.in by configure.  */
/* src/config/natu-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Natu_CONFIG_H

#define Natu_CONFIG_H
...
#define PACKAGE_BUGREPORT "natu.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NATU Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NATU Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "natu"
