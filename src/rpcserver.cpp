...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NATU features */
        {"natu", "masternode", &masternode, true, true, false},
        {"natu", "listmasternodes", &listmasternodes, true, true, false},
        {"natu", "getmasternodecount", &getmasternodecount, true, true, false},
        {"natu", "masternodeconnect", &masternodeconnect, true, true, false},
        {"natu", "masternodecurrent", &masternodecurrent, true, true, false},
        {"natu", "masternodedebug", &masternodedebug, true, true, false},
        {"natu", "startmasternode", &startmasternode, true, true, false},
        {"natu", "createmasternodekey", &createmasternodekey, true, true, false},
        {"natu", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"natu", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"natu", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"natu", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"natu", "getmasternodescores", &getmasternodescores, true, true, false},
        {"natu", "mnbudget", &mnbudget, true, true, false},
        {"natu", "preparebudget", &preparebudget, true, true, false},
        {"natu", "submitbudget", &submitbudget, true, true, false},
        {"natu", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"natu", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"natu", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"natu", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"natu", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"natu", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"natu", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"natu", "checkbudgets", &checkbudgets, true, true, false},
        {"natu", "mnsync", &mnsync, true, true, false},
        {"natu", "spork", &spork, true, true, false},
        {"natu", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"natu", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use natud, or the -server option to natu-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> natu-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23211/\n";
}
