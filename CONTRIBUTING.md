Contributing to NATU
============================

The NATU project operates an open contributor model where anyone is
...
The following applies to code changes to the NATU project, and is not to be
confused with overall NATU Network Protocol consensus changes.

Whether a pull request is merged into NATU rests with the project merge
...
Patches that change NATU consensus rules are considerably more involved than
...
Where a patch set proposes to change the NATU consensus, it must have been
...
The project leader is the release manager for each NATU release.
