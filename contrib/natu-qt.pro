...
RESOURCES += src/qt/natu.qrc src/qt/natu_locale.qrc

TRANSLATIONS += src/qt/locale/natu_bg.ts \
                src/qt/locale/natu_de.ts \
                src/qt/locale/natu_en.ts \
                src/qt/locale/natu_es.ts \
                src/qt/locale/natu_fi.ts \
                src/qt/locale/natu_fr.ts \
                src/qt/locale/natu_it.ts \
                src/qt/locale/natu_ja.ts \
                src/qt/locale/natu_pl.ts \
                src/qt/locale/natu_pt.ts \
                src/qt/locale/natu_ru.ts \
                src/qt/locale/natu_sk.ts \
                src/qt/locale/natu_sv.ts \
                src/qt/locale/natu_vi.ts \
                src/qt/locale/natu_zh_CN.ts \
                src/qt/locale/natu_zh_TW.ts
