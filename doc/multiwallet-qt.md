...
In order to support loading of multiple wallets in natu-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is natu.cpp.
...
Changes to natu.cpp
----------------------
natu.cpp is the entry point into natu-qt, and as such, will require some minor modifications to provide hooks for
